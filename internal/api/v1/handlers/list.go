...
type ListClusterResourceFunc[T any] func(context.Context, *dockyardsv1.Cluster) (*[]T, error)

func ListClusterResource[T any](h *handler, resource string, f ListClusterResourceFunc[T]) http.HandlerFunc {
