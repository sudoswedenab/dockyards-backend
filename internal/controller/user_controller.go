...
func (r *UserReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, reterr error) {
	...
	// Users created through the tests don't pass TypeMeta, setting it manually
	if user.TypeMeta == (metav1.TypeMeta{}) {
		user.Kind = dockyardsv1.UserKind
		user.APIVersion = dockyardsv1.GroupVersion.String()
	}

	verificationRequest := dockyardsv1.VerificationRequest{
		TypeMeta: metav1.TypeMeta{
			Kind:       dockyardsv1.VerificationRequestKind,
